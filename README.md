...
Take key.pem and convert the TPM public key to the ssh-rsa BASE64 username format: `ssh-keygen -f key.pem -i -m PKCS8`. Update echoserver.c user "jill"'s public key.
